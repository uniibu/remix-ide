...
.. image:: images/debugger/debug-button.png
   :alt: Debug button in the Remix terminal next to a transaction log entry
...
.. video:: images/debugger/activate-debugger.mp4
   :nocontrols:
   :autoplay:
   :playsinline:
   :muted:
...
.. image:: images/debugger/debugger-overview.png
   :alt: Overview of the Remix Debugger interface
...
.. image:: images/debugger/generated-sources.png
   :alt: Debugger showing a generated Yul file in the editor with Use generated sources enabled
...
.. image:: images/debugger/debugger-navigation.png
   :alt: Debugger navigation buttons including Step Backward, Step Back, Step Into, Step Forward, and breakpoint controls
...
.. image:: images/debugger/transaction-details.png
   :alt: Transaction Details panel showing metadata for a debugged transaction
...
.. image:: images/debugger/call-trace.png
   :alt: Call Trace panel showing the sender and internal calls of a transaction
...
.. image:: images/debugger/state-and-locals.png
   :alt: State and Locals tab showing locals and state variables in JSON format
...
- ``stack``: the EVM operand stack at the current step. For more info about the `stack <https://en.wikipedia.org/wiki/Stack_(abstract_data_type)>`_.
...
.. image:: images/debugger/stack-and-memory.png
   :alt: Stack and Memory tab showing low level EVM execution state
...
.. image:: images/debugger/execution-trace.png
   :alt: Execution trace area prompting the user to select a call from the Call Trace
